    ...
    <main className="flex flex-col">
      <DarkContainer>
        <section className="flex flex-col py-12 md:py-[72px] items-center justify-center">
          ...
          <div className="relative -top-[56px] bg-gradient-to-r from-cyan-400 to-yellow-300 dark:from-cyan-800 dark:via-cyan-400 dark:to-yellow-300 h-4 w-[100px] lg:w-[173px] lg:-top-[64px] lg:-left-[0px]" />
