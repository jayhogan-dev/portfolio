...
export default function Home() {
  return (
    <main className="flex flex-col items-center pt-6 gap-6 md:flex-row md:justify-between lg:gap-10 xl:gap-32">
      <div className="flex flex-col gap-4 w-full lg:w-2/5">
        ...
        <h1 className="text-primary-black-200 dark:text-white text-4xl leading-[115%] lg:text-heading2 xl:text-heading1 font-bold w-[320px] lg:w-[400px] xl:w-[500px]">
        ...
        <div className="flex flex-col w-full gap-4 lg:flex-row">
          <Button className="lg:w-1/3">My Work</Button>
          <Button
            variant="default"
            className="lg:w-2/3"
          >
