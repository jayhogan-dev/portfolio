...
const FeaturedProjectsCardEven = ({
  ...
  return (
    <article className="flex flex-col">
      ...
      >
        <div className="flex flex-col gap-7 sm:mr-10 xl:mr-20 sm:w-[450px] xl:w-[500px] justify-center">
        ...
        <div className="flex items-end md:pt-5 overflow-hidden">
          ...
          <div className="-ml-3 relative w-[60px] h-[112px] sm:h-[200px] sm:w-[125px] lg:h-[220px] lg:w-[150px] xl:h-[260px] md:ml-0 lg:-mr-5 md:hidden lg:flex">
            <Image
              src={mobileImage}
              alt="phone"
              fill
