...
const CaseStudyCard = ({
  ...
  return (
    <div className="flex flex-col gap-5">
      <Link
        href={linkUrl}
        className="flex h-52 w-80 sm:h-56 sm:w-[350px] lg:h-64 lg:w-[420px] xl:h-72 xl:w-[550px] relative rounded-2xl hover:animate-pulse bg-primary-blue-light dark:bg-primary-blue-dark"
      >
