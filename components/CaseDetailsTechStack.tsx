...
const CaseDetailsTechStack = () => {
  return (
    <LightContainer>
      <section className="flex flex-col py-12 gap-6 md:py-[72px] items-start justify-start w-full sm:w-[500px] md:w-[880px]">
        <div className="flex flex-col bg-red-300 w-full sm:flex-row justify-between gap-5 md:gap-0">
