    ...
    <article className="flex flex-col">
      ...
      >
        ...
        <div className="flex items-end md:pt-5 overflow-hidden">
          <div className="relative w-[230px] h-32 sm:w-[400px] sm:h-[250px] sm:max-w-[400px] sm:min-w-[400px] lg:h-[275px] lg:w-[450px] lg:max-w-[450px] lg:min-w-[450px] xl:h-[300px] z-10">
            <Image
              src={laptopImage}
              alt="laptop"
              fill
          ...
          <div className="-ml-3 mb-3 relative w-[60px] h-[112px] sm:h-[200px] sm:w-[125px] lg:h-[220px] lg:w-[130px] lg:min-w-[130px] lg:max-w-[130px] xl:h-[250px] md:ml-0 lg:-mr-5 md:hidden lg:flex xl:-mr-8">
            <Image
              src={mobileImage}
              alt="phone"
              fill
